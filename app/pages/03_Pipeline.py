"""Module 3: Pipeline Visualizer - 8-stage funnel with friendly names."""
import sys
...
from utils.styles import CUSTOM_CSS, COMPARTMENT_COLORS, get_compartment_name
...
pipeline_html = "<div style='background-color: white; padding: 24px; border-radius: 12px;'>"
...
for code, name, desc in stages:
    ...
    width_pct = max(width_pct, 5)  # Min 5% for visibility
