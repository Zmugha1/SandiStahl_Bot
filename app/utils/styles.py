...
# Compartment colors: bar=fill, bg=background, border=accent
COMPARTMENT_COLORS = {
...
# Friendly names for compartment codes
COMPARTMENT_NAMES = {
    "IC": {"short": "Discovery", "full": "Discovery - First Meeting"},
    "C1": {"short": "Learning", "full": "Learning - Education Phase"},
    "C1.1": {"short": "Exploring", "full": "Exploring - Narrowing Options"},
    "C2": {"short": "Researching", "full": "Researching - Brand Validation"},
    "C3": {"short": "Deciding", "full": "Deciding - Serious Consideration"},
    "C4": {"short": "Committing", "full": "Committing - Ready to Sign"},
    "C5": {"short": "Launching", "full": "Launching - In Training"},
    "CLOSED": {"short": "Complete", "full": "Complete - Deal Done"},
}
